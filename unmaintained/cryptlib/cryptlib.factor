...
: with-cryptlib ( quot -- )
        [ init [ end ] finally ] with-scope ; inline
...
: with-context ( algo quot -- )
        swap create-context [ destroy-context ] finally ; inline
...
: with-keyset ( type name options quot -- )
        >r open-keyset r> [ close-keyset ] finally ; inline
...
: with-certificate ( type quot -- )
        swap create-certificate [ destroy-certificate ] finally ; inline
...
: with-envelope ( format quot -- )
        swap create-envelope [ destroy-envelope ] finally ;
...
: with-session ( format quot -- )
        swap create-session [ destroy-session ] finally ;
